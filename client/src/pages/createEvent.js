      ...
      <Form>
           <Row>
            ...
            <Row>
                ...
                <Col>
                    ...
                    <Form.Select class="form-control" id="inputState" name="state" value={newevent.state} onChange={handleChange}>
                ...
                <Col>
                    ...
                    <Form.Select class="form-control" id="inputDistrict" name="district" value={newevent.district} onChange={handleChange}>
          ...
          <Row>
              ...
              <Col>
                ...
                <Form.Label htmlFor="registrationDate">Registration Date Deadline</Form.Label>
                  <Col>
                   <DatePicker
              ...
              <Col>
                <Form.Label htmlFor="minParticipation">Minimum Participation:</Form.Label>
                 <Form.Control
                    type="number"
                    id="minParticipation"
